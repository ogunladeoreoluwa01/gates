<template>
    ...
    <div class="flex w-[350px] flex-col gap-2 justify-center items-center">
      <div class="w-[350px]">
        ...
        <div class="flex gap-4 items-center flex-wrap w-[350px] py-2">
          <div class="flex items-center justify-center font-raleway font-medium z-50">
  ...
  <section class="app md:flex mb-10 flex-col gap-3 hidden">
      ...
      <div class="flex">
        <div class="relative flex items-end gap-5">
          <input
            ...
            v-model="searchQuery"
            @keydown.enter="handleSearchButtonClick"
            class="md:w-[30rem] border-b border-zinc-700 dark:border-zinc-200 py-1 focus:border-b-2 focus:border-zinc-950 dark:focus:border-zinc-50 transition-colors focus:outline-none peer bg-inherit duration-200 ease-in-out indent-16 dark:text-zinc-50"
          />
          <label
            for="Search"
