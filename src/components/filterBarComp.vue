<template>
  <section class=" app w-[350px] flex md:hidden flex-col justify-center items-center mx-auto">
    <div class="flex flex-col gap-2 justify-center items-center w-[350px] ">
      <div class="w-[350px]">
        ...
        <section class="flex items-center gap-2 dark:text-zinc-50">
          <svg
          ...
          <div class="flex gap-2 w-[350px] overflow-auto items-center group py-2">
  ...
  <section class="app hidden md:flex mb-10 flex-col gap-3">
    <section class="flex items-center w-full justify-between">
      <div class="flex">
        <div class="relative flex items-end gap-5 z-50">
          <input
            id="Search"
            name="Search"
            type="text"
      ...
      <div class="flex gap-8 items-center z-50">
        <div class="flex items-center justify-center font-raleway font-medium">
