...
<script>
import filterBarComp from '../components/fillterBarCompMangaTags.vue'
...
export default {
  ...
  mounted() {
    ...
    this.country = query.country ? query.country.toUpperCase() : undefined
    setTimeout(() => {
      this.fetchData()
    }, 500)
    setTimeout(() => {
